...
ninja.data = [{
    ...
    handler: () => {
      ...
      handler: () => {
          ...
          description: "",
          section: "News",},{id: "news-find-me-at-vldb-2022-in-australia",
          title: 'Find me at VLDB 2022 in Australia',
          description: "",
          ...
          description: "",
          section: "News",},{id: "projects-endure",
          title: 'Endure',
          description: "Under construction!",
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://orcid.org/0000-0002-2843-6565", "_blank");
        },
      },{
        id: 'social-rss',
        title: 'RSS Feed',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=fhHkBB8AAAAJ", "_blank");
        },
      },{
      id: 'light-theme',
